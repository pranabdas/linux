...
<CodeBlock language="bash" title="src/deg_f_to_c_conv.sh">{deg_f_to_c_conv}</CodeBlock>
...
<CodeBlock language="bash" title="src/github_emoji.sh">{github_emoji}</CodeBlock>
